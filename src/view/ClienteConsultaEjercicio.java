...
public class ClienteConsultaEjercicio extends JFrame {
	...
	public ClienteConsultaEjercicio() throws HeadlessException {
	...
	private void inicializar() {
			...
			btnLimpiar.setBounds(10, 533, 352, 23);
			...
			lblInstrucciones.setBounds(10, 324, 80, 20);
